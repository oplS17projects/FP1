...
(check-expect (check-temps (list 4 10  20 95) 10 100) false)
(check-expect (check-temps (list 5 10  20 97) 5 90) false)
...
(check-expect (check-temps (cons 0 (cons 0 (cons 0 empty))) 0  0) false)
